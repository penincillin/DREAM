...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, extract_feature=False, end2end=False):
        self.inplanes = 64
        ...
        feat_dim = 256
        self.feature = nn.Linear(512 * block.expansion, feat_dim)
        if self.end2end:
